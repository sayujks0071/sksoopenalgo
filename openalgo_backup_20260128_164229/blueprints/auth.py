...
@auth_bp.route('/login', methods=['GET', 'POST', 'HEAD'])
...
def login():
    ...
    try:
        ...
        with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
            f.write(json.dumps({"sessionId":"debug-session","runId":"browser-connection","hypothesisId":"F","location":"auth.py:33","message":"Login route accessed","data":{"method":request.method,"remote_addr":request.remote_addr,"user_agent":request.headers.get('User-Agent','')[:50]},"timestamp":int(__import__('time').time()*1000)}) + '\n')
    except: pass
    # #endregion agent log
    ...
    if request.method == 'HEAD':
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"browser-response","hypothesisId":"G","location":"auth.py:44","message":"HEAD request handled","data":{"status":200},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
        return '', 200
    ...
    if find_user_by_username() is None:
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"browser-response","hypothesisId":"G","location":"auth.py:47","message":"Redirecting to setup","data":{},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
    ...
    if 'user' in session:
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"browser-response","hypothesisId":"G","location":"auth.py:50","message":"Redirecting to broker_login","data":{},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
    ...
    if session.get('logged_in'):
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"browser-response","hypothesisId":"G","location":"auth.py:53","message":"Redirecting to dashboard","data":{},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
    ...
    if request.method == 'GET':
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"browser-response","hypothesisId":"G","location":"auth.py:56","message":"Rendering login template","data":{},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
        try:
            ...
            try:
                with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"browser-response","hypothesisId":"G","location":"auth.py:62","message":"Login template rendered successfully","data":{"response_length":len(str(result)) if result else 0},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            except: pass
            # #endregion agent log
            return result
            ...
            try:
                with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"browser-response","hypothesisId":"G","location":"auth.py:68","message":"Error rendering login template","data":{"error":str(e),"type":type(e).__name__},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            except: pass
            # #endregion agent log
            raise
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"login-attempt","hypothesisId":"H","location":"auth.py:103","message":"POST request received","data":{"form_keys":list(request.form.keys()),"content_type":request.content_type},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
        ...
        try:
            ...
            try:
                with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"login-attempt","hypothesisId":"H","location":"auth.py:108","message":"Missing form field","data":{"error":str(e),"form_keys":list(request.form.keys())},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            except: pass
            # #endregion agent log
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"login-attempt","hypothesisId":"H","location":"auth.py:115","message":"Login attempt","data":{"username":username,"password_length":len(password) if password else 0},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"login-attempt","hypothesisId":"H","location":"auth.py:111","message":"Authentication result","data":{"username":username,"authenticated":auth_result},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
        
        if auth_result:
            session['user'] = username  # Set the username in the session
            # Set logged_in flag to prevent session from being cleared
...
@limiter.limit(LOGIN_RATE_LIMIT_HOUR)
def broker_login():
    # Only redirect to dashboard if user is logged in AND broker is connected
