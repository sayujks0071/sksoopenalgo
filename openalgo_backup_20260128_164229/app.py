...
if __name__ == '__main__':
    ...
    try:
        with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
            f.write(json.dumps({"sessionId":"debug-session","runId":"startup-check","hypothesisId":"A","location":"app.py:566","message":"Starting app.py main block","data":{"pid":os.getpid()},"timestamp":int(__import__('time').time()*1000)}) + '\n')
    except: pass
    # #endregion agent log
    ...
    try:
        with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
            f.write(json.dumps({"sessionId":"debug-session","runId":"startup-check","hypothesisId":"A","location":"app.py:571","message":"Environment variables loaded","data":{"host_ip":host_ip,"port":port,"ws_port":ws_port,"debug":debug},"timestamp":int(__import__('time').time()*1000)}) + '\n')
    except: pass
    # #endregion agent log
    ...
    try:
        with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
            f.write(json.dumps({"sessionId":"debug-session","runId":"startup-check","hypothesisId":"B","location":"app.py:704","message":"About to call socketio.run","data":{"host_ip":host_ip,"port":port},"timestamp":int(__import__('time').time()*1000)}) + '\n')
    except: pass
    # #endregion agent log
    try:
        ...
        try:
            with open('/Users/mac/dyad-apps/probable-fiesta/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"startup-check","hypothesisId":"C","location":"app.py:710","message":"socketio.run exception","data":{"error":str(e),"type":type(e).__name__},"timestamp":int(__import__('time').time()*1000)}) + '\n')
        except: pass
        # #endregion agent log
        raise