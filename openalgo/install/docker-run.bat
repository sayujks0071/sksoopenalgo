...
powershell -Command "(Get-Content '%OPENALGO_DIR%\%ENV_FILE%') -replace 'REDACTED_APP_KEY', '%APP_KEY%' | Set-Content '%OPENALGO_DIR%\%ENV_FILE%'"
powershell -Command "(Get-Content '%OPENALGO_DIR%\%ENV_FILE%') -replace 'REDACTED_API_KEY_PEPPER', '%API_KEY_PEPPER%' | Set-Content '%OPENALGO_DIR%\%ENV_FILE%'"
