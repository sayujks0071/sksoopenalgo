#!/usr/bin/env python3
"""
SensexProductionIronCondor - SENSEX Weekly Options (OpenAlgo Web UI Compatible)
SENSEX Weekly Iron Condor Strategy for Weekly Income on BSE (BFO).
...
- Sells OTM2 CE/PE, Buys OTM4 CE/PE.
- Risk Management: SL 35% of Net Credit, TP 45% of Net Credit.
- Max Hold: 45 minutes.
- Friday Expiry: Hard Exit at 14:00.
...
# ===========================
STRATEGY_NAME = os.getenv("STRATEGY_NAME", "sensex_production_iron_condor")
...
class SensexProductionIronCondor:
    def __init__(self):
...
if __name__ == "__main__":
    strategy = SensexProductionIronCondor()
    strategy.run()
