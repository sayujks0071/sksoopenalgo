#!/usr/bin/env python3
"""
Nifty Production Iron Condor (OpenAlgo Web UI Compatible)
High-Probability Nifty Weekly Income Strategy.
Logic:
- Entry: > 10:00 AM, if ATM Straddle Premium > 120.
...
# CONFIGURATION
# ===========================
STRATEGY_NAME = os.getenv("STRATEGY_NAME", "NiftyProductionIronCondor")
            ...
            try:
                ...
                if not self.tracker.open_legs and not self.entered_today:
                    ...
                    if start_time_dt <= now.time() <= end_time_dt:
                        ...
                        # Outside entry window, just log occasionally
                        pass
