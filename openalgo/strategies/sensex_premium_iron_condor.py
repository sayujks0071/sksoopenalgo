#!/usr/bin/env python3
"""
SensexPremiumIronCondor - SENSEX Weekly Options (OpenAlgo Web UI Compatible)
...
# ===========================
STRATEGY_NAME = os.getenv("STRATEGY_NAME", "sensex_premium_iron_condor")
...
if __name__ == "__main__":
    strategy = SensexPremiumIronCondor()
    strategy.run()
